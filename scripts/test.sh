...
nvim --headless -u NONE -i NONE -n +"set rtp+=." +"edit README.md" +"lua require('line-history').setup({ keymap = false, treesitter = { enabled = false } })" +"1,1LineHistory" +"doautocmd FocusGained" +"qa!"
